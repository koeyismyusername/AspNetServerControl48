<%@ Page Title="전화 번호 확인" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="AspNetServerControlExam.Account.VerifyPhoneNumber" %>
